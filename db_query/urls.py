...
issue_urls = [
    ...
    path('issue/<int:issue_id>/stories', views.stories_by_issue, name='stories'),
    path('issue/<int:issue_id>/credits', views.credits_by_issue, name='credits'),
    path('issue/<int:issue_id>/creators', views.creators_by_issue, name='creators'),
...
creator_urls = [
    ...
    #      name='creator_series'),
    path('creator/<int:creator_id>/credits', views.creator_credits, name='creator_credits'),
    path('creators/<str:creator_ids>/name_details', views.name_detail_by_creator,
         name='name_detail_by_creator'),
    path('creator_list/<str:creator_ids>', views.creators_list, name='creators_list'),
    path('creator_name/<str:name>/stories', views.stories_by_name, 'stories_by_name')
]

name_detail_urls = [
    path('name_detail/name/<str:name>', views.creator_by_name, name='creator_by_name'),
    path('name_detail/<str:name_detail_ids>', views.name_detail_list, name='name_detail_list'),
    path('name_detail/<str:name_detail_ids>/stories', views.stories_by_name_detail,
         name='creator_series'),
]
